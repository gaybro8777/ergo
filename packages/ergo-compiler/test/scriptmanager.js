...
describe('ScriptManager', () => {
    ...
    describe('#constructor', () => {
        ...
        it('should support both JavaScript and Ergo scripts', async function() {
            ...
            scriptManager.getCompiledScript().getContents().length.should.equal(26214);
            scriptManager.getCompiledJavaScript().length.should.equal(26214);
        ...
        it('should compile Ergo scripts', async function() {
            ...
            scriptManager.addScript(script1);
            scriptManager.addScript(script2);
            scriptManager.compileLogic().getContents().length.should.equal(26214);
            scriptManager.getCompiledScript().getContents().length.should.equal(26214);
