...
describe('TemplateLogic', () => {
    describe('#constructors-accessors', () => {
        ...
        it('should load a logic file to the script manager', () => {
            ...
            templateLogic.getScriptManager().getCompiledScript().getContents().length.should.equal(26214);
            templateLogic.compileLogicSync(false);
            templateLogic.getScriptManager().getCompiledScript().getContents().length.should.equal(26214);
        });
        ...
        it('should set the compilation target to ES6 and recompile the logic', () => {
            ...
            templateLogic.getScriptManager().getCompiledScript().getContents().length.should.equal(27055);
        });
        ...
        it('should set the compilation target to ES5', () => {
            ...
            templateLogic.getScriptManager().getCompiledScript().getContents().length.should.equal(26915);
        });
